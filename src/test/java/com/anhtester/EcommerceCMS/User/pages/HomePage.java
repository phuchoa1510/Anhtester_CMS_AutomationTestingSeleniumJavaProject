...
public class HomePage extends BasePage {
    ...
    private By buttonLogout = By.xpath("//a[text()='My Panel']/parent::li/following-sibling::li[1]/a");

    private By buttonMyPanel = By.xpath("//a[normalize-space()='My Panel']");

    private By iconAnhtester = By.xpath("//header//img[@alt='Active eCommerce CMS']");
